...
import com.pruqa.matchmakersettings.exceptions.InvalidHeadersException;
...
@Slf4j
@Component
public class SettingsControllerInterceptor implements HandlerInterceptor {

    private static final String SETTINGS_API = "/settings/api/";
